    ...
    <div className="flex flex-col justify-center items-center space-y-24 pt-4 pb-12">
      ...
      <div className="flex space-y-12  flex-col ring ring-prime w-2/3 rounded-md justify-center items-center p-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-x-12">
          ...
          With more than 6.8 million refugees leaving Ukraine, around 3,500 civilians killed, the aggressors losing a thousand tanks, more than 25 countries pledging to help the Ukraine military defence (the US reportedly spending $100 million every single day), a conflict has grown into an all out war. And it seems to have extended into the economic base as well, as the US and NATO put several sanctions on Russia. 
As the sanctions are designed to wreak the Russian economy, we see the US, UK, the EU and Canada to be the major players- wishing to “hold Russia to account and collectively ensure that this war is a strategic failure for Putin.” 
The world has been divided over the Ukraine conflict, making it as of right now, one of the most important violent issues to resolve.
